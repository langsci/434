...
\title{Investigating grammatical borrowing in Mosetén through historical sources}
...
Indeed, we even find the use of masculine gender agreement when referring to various people of mixed (or unclear) gender, despite there being variation in modern Mosetén (cf examples 1 and 2 above):
...
While there are not many examples of phrasal word order in Herrero, those that appear are ADJ-N (repeated from 9):
