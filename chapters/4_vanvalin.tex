...
On p. 198 of \citew{everett2017language} there is a partial RRG tree diagram illustrating some of the structural complexity in a $G_3$ grammar.  That tree represents only one of the four projections of the clause posited in RRG: there are constituent, operator, information structure, and prosodic projections. Only the first two are represented in Figure \ref{fig:fig1} below.  
...
\itdopt{use latex reference meachism for whole book}
