...
\VanLabel{if} & illocutionary force \\
\VanLabel{nuc} & nucleus \\
\VanLabel{prcs} & pre-core slot \\
\VanLabel{prdp} & pre-detached position \\
\VanLabel{pred} & predicator \\
\end{tabularx}\begin{tabularx}{.5\textwidth}{lQ@{}}
\VanLabel{prop} & propositional \\
\VanLabel{re} & referring expression \\
\VanLabel{rp} & reference phrase \\
\VanLabel{spkr} & speaker \\
\VanLabel{tns} & tense \\
\end{tabularx}
