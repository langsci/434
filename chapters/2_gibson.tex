...
tree structure in Figure~\ref{fig-the-girl-saw-the-dog}.
...
then we have \textit{self-embedding} of A within A. The grammar in \exref{cfg1} has three instances
...
the above grammar are provided in the Figures~\ref{fig-Mary-thinks-the-girl-saw-the-dog} and~\ref{fig-Alison-says-Mary-thinks-the-girl-saw-the-dog}:
...
\begin{table}
    ...
    \lspbottomrule
    \end{tabularx}
\itdopt{Sebastian: fix sticking out part}
\end{table}
