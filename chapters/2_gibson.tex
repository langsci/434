...
tree structure in Figure \figref{fig-the-girl-saw-the-dog}.
...
the above grammar are provided in the Figures \figref{fig-Mary-thinks-the-girl-saw-the-dog} and \figref{fig-Alison-says-Mary-thinks-the-girl-saw-the-dog}:
...
A second response to Everett’s claim has been to suggest that Pirahã probably does have syntactic self-embedding, in the same way that English does. \citet{sauerland2018false} suggests that this is the case, based on experimental data that he gathered when visiting the Pirahã. I discuss in more detail in Section \sectref{sauerland_sec}.
...
The 70 responses from our 9 participants on this task were distributed as in Table \tabref{gibson_table_1}.  Of the 13 two-clause responses, all were likely parataxis, consisting of pairs of clauses like \textit{canoe paddle} and \textit{same eat farinha}, where the Pirahã word for \textit{same} connects the subjects of the two clauses.
