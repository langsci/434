...
\caption{\label{fig:gil:fig2}Semantic structure of \REF{ex:gil:1}}
\end{figure}
...
Conversely, it also correctly predicts that \textit{yang suka anjing}, a constituent in \figref{fig:gil:fig3} but not in \figref{fig:gil:fig1}, cannot be moved to the beginning of the sentence, as in \REF{ex:gil:3} below, without a massive change in meaning:
...
In \REF{ex:gil:10} above, the last verse is presented, containing a total of 10 clauses, of which the last 9, introduced by the Aramaic relativizer \textit{de-}, are embedded, each within the clause immediately preceding it, like a set of Matryoshka dolls.  
