...
As indicated above, the interpretation associated with sentence \REF{ex:gil:1} is completely unavailable in (\ref{ex:gil:3}).  More dramatically, the hierarchical syntactic structure of Figure \ref{fig:gil:fig1} predicts the total unacceptability, salva veritate, of various random reshufflings of the words in \REF{ex:gil:1} such as in (\ref{ex:gil:4}) below:
