...
\abstract{In the spirit of Dan Everett's famous claims about Pirahã, this paper turns to the Riau dialect of Indonesian, and poses the question whether it has syntactic recursion. The answer is: \textit{Yes and No}. Grammatically, Riau Indonesian syntax is clearly recursive; sentences can be constructed of arbitrary length and with any number of levels of nested syntactic constituents. However, unlike in English, subordination, especially that involving multiple levels of embedding, is vanishingly rare in naturalistic usage, not only in speech but also in writing — as evidenced by a contrastive quantitative analysis of Google searches in English and Malay/Indonesian. To capture such facts, it is argued that knowing a language involves mastery not only of its lexicon and grammar but also of its linguistic perspective, an array of conventionalized choices that we make by encoding certain aspects of our conceptualization of reality while leaving others unexpressed. In particular, while the overt expression of logical subordination is commonly expressed in English, it is strongly dispreferred in Riau Indonesian. Thus, languages may vary in the extent to which they allow for subordination both in their grammars and in their conventionalized patterns of usage, or linguistic perspectives. The cross-linguistic propensity for syntactic recursion may be gauged through an examination of the distribution of cumulative tales such as the Hebrew/Aramaic song \textit{Had Gadya}. While cumulative tales are attested around the world, a preliminary survey suggests that tales involving syntactic embedding, such as in Had Gadya, are limited in their distribution to the Middle East, North Africa and Europe, thereby casting doubt on the supposed exceptionality of Pirahã as a language lacking syntactic recursion. Drawing upon recent studies supporting the existence of a positive correlation between social and syntactic complexity, it is suggested that the differential propensity for recursion in Pirahã, Riau Indonesian and English reflects the relative degrees of complexity of their associated societies — a small and isolated population, a larger population speaking a regional variety of a national language, and the hundreds of millions of speakers of a world language.}
...
\begin{document}
\maketitle
\itdopt{Please shorten abstract so that it fits on the title page --FK}
...
appear)\todosatz{ref missing} for a detailed application of this notion to the field of diachronic syntax and language contact.
