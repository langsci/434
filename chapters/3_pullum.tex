...
in \figref{fig:pullum:1a} is claimed to have an analogous left-branching structure in
...
English structure in \figref{fig:pullum:1a}~-- where I omit determiners to save space
-- has an exact analog in Pirahã, which they depict
(in their (19) on p.\,287) as shown in \figref{fig:pullum:1b}.
...
tree in (\figref{fig:pullum:1b}). In fact there's a good reason that languages with nouns
...
pronunciation of the purely fictional phrase (\figref{fig:pullum:1b}). Given that the word
