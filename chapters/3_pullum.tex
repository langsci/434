...
indigenous language Pirahã (\textit{Current Anthropology} 46.4, 2005)
...
dispute lie in sentence complexity: in effect, whether Pirahã
...
``recursion'' in Pirahã range from inconclusive to incompetent.
...
events described in \sectref{war} below, was sentence structure.
...
be concerned with here. In \sectref{prehistory} I will turn to the rather meager
...
quoting the river traders (see \sectref{river}) is hardly
...
little bit of attention.''\footnote{%
   ...
   of the film, retitled as ``Decoding Amazon: life of the Pirahã'',
...
support the Chomskyan line, and that he did. (See \sectref{ppsection}
...
the languages I discussed in \sectref{intro} for which the possibility
...
such as English \data{that} in Pirahã'' (p.\,262). In the early 1980s
...
Pirahã NP, just as in English. In example (268) of \citet[273]{Everett86HAL} he cited \REF{ex:pullum:4} as the largest NP he had
...
whether \REF{ex:pullum:4} was acceptable, he was told: ``Pirahã don't say that.
...
the rhetorical escape-hatch arguments (see \sectref{intro} above),
...
Pirahã with the terminal string \data{tabo apo tiapapati apo
...
\hspace*{2em}\scalebox{0.55}{\includegraphics{figures/pullum_figure2.pdf}}
    \caption{Left: PP modifiers of NP in English. Right: \citegen{SandaloEtAl18} Pirahã PP structure}
    \label{fig:pullum:1}
\end{figure}
...
the sequence of elements in the NP as follows (p.\,273):\footnote{%
   See also \citew[132--136]{Everett83}. Pirahã has no true
...
apo tabo apo'' (intended to be \data{gi{\'\i}goho{\'\i} kapiiga
...
up quite a few candidates, as discussed in \sectref{intro}.
...
\noindent
[Daniel and Keren Everett's relationship with the Pirahã is something
...
storytellers and of becoming important allies, to whom the Pirahã
