...
\itdopt{Examples have to be done in gb4e.}
\itdopt{See (1–4) for examples --FK}
\itdopt{Please use \textbackslash REF to refer to examples --FK}
\itdopt{Please put all trees in figures and add captions. See }
...
No one has ever suggested that PPs like in \figref{fig:pullum:3} are encountered 
in Pirah{\~a}
