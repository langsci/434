...
\itdopt{Examples have to be done in gb4e. -MP: done}
\itdopt{See (1–4) for examples --FK. -MP: done}
\itdopt{Please use \textbackslash REF to refer to examples --FK. -MP: done}
\itdopt{Please put all trees in figures and add captions. -MP: done}
...
treatment of its indigenous inhabitants (Pullum 1978)\todosatz{Reference is missing}, and together
...
\ea
\label{ex:pullum:2}
\ea \gll \data{K{\'o}{\textglotstop}oi} \data{so{\textglotstop}{\'o}{\'a}}
...
But \REF{ex:pullum:3} is problematic in a way that Nevins et al.\ were unaware
...
\ea
\label{ex:pullum:5}
\data{Pai{\'o} hi ab{\'o}paisa{\'\i}
            ti {\textglotstop}i{\'\i} o{\'a}bo{\'\i}ha{\'\i}.} \\
\gll  \data{Pai{\'o}} \data{hi} \data{ab{\'o}p-ai-sa{\'\i}}
            \data{ti} \data{{\textglotstop}i{\'\i}} \data{o{\'a}-bo{\'\i}-ha{\'\i}} \\
...
\ea
\label{ex:pullum:7}
\gll \data{t{\'a}bo} \data{{\textglotstop}apo{\'o}} 
 \data{t{\'\i}apap} \data{{\textglotstop}apo{\'o}} \data{kapiiga} \data{{\textglotstop}apo{\'o}} \data{gi{\'\i}go-ho{\'\i}} \\
