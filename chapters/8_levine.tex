...
\begin{sidewaysfigure}
 \caption{\color{red}Please provide a caption.}\label{sentProof}
\oneline{%
...
detailed critques of these approaches, see \citealt{levine11} and 
...
\BinaryInfC{\LexEnt{\pt{bought \circ{} p}}{\sem{ \trns{buy}(x)}}{\syncat{VP}}}
...
\begin{figure}
\caption{\color{red}Please provide a caption}\label{bookProof2}
...
\begin{figure}
\caption{\color{red}Please provide a caption}\label{length}
% \oneline{%
...
\begin{figure}
\caption{\color{red}Please provide a caption. Please reference this Figure somewhere in your main text.}\label{simpleVPEproof}
...
\caption{\color{red}Please provide a caption}\label{GeachRule}
...
\begin{figure}
\caption{\color{red}Please provide a caption}\label{conjPseudo-b}
...
\begin{figure}
\small
\caption{\color{red}Please provide a caption}\label{part1}
...
\begin{figure}
\caption{\color{red}Please provide a caption}\label{subproof}
