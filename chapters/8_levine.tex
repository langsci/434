...
%= Title
\title{A Peircean turn in linguistics: syntactic-semantic
composition as logical inference\thanks{The analyses and results
...
%This is a template .rdx file. For some instructions for how to write
%your own definitions for abbreviatory notation for complex LaTeX
%expressions, see the `postamble' section starting with the line
...
Tesni\`{e}re' \citet{hollein2022}. There were, as noted in \citet{AdamP-Peirce}, a
...
hydrogen atoms to form the ammonia molecule NH\fb{\,\,{\rm 3}}, and
Przepi{\'o}rkowski considers it likely that Tesni\`{e}re and the
...
N\"{o}th observes, for Peirce, `the key to syntactic structure is the
...
\AxiomC{\Lemma}
\UnaryInfC{\Lemma}
\AxiomC{\ensuremath{[\LexEnt{\pt{\ensuremath{\greekp}}}{\sem{ x }}{\syncat{\textit{A}}}]^1\,\,}}
\UnaryInfC{\LemmaAlt}
\AxiomC{\Lemma}
\UnaryInfC{\Lemma}
\TrinaryInfC{\LexEnt{\pt{\ptv{b} \O \pt{\ensuremath{\greekp}} }}{\sem{ \sF}}{\syncat{\textit{B}}}}
\RightLabel{\scalebox{.8}{/I$^n$}}
\UnaryInfC{\LexEnt{\pt{\ptv{b}}}{\sem{ \lambda x. \sF}}{\syncat{\textit{B}/\textit{A}}}}
\DisplayProof}
&
{ 
\AxiomC{\LexEnt{\pt{\ptv{b}}}{\sem{ \calP}}{\syncat{\textit{B}/\textit{A}}}}
\AxiomC{\LexEnt{\pt{\ptv{a}}}{\sem{ \alpha}}{\syncat{\textit{A}}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\LexEnt{\pt{\ptv{b} \O \ptv{a}}}{\sem{ \calP(\alpha)}}{\syncat{\textit{B}}}}
\DisplayProof}\\
& & & \\[-1ex]
\bsl &
{ 
...
\AxiomC{\Lemma}
\UnaryInfC{\Lemma}
\TrinaryInfC{\LexEnt{\pt{\pt{\ensuremath{\greekp}} \O \ptv{b}}}{\sem{ \sF}}{\syncat{\textit{B}}}}
\RightLabel{\scalebox{.8}{\bsl I$^n$}}
\UnaryInfC{\LexEnt{\pt{\ptv{b}}}{\sem{ \lambda x. \sF}}{\syncat{\textit{A}\bsl{}\textit{B}}}}
\DisplayProof}
&
{ 
\AxiomC{\LexEnt{\pt{\ptv{a}}}{\sem{ \alpha}}{\syncat{\textit{A}}}}
...
\BinaryInfC{\LexEnt{\pt{\ptv{a} \O \ptv{b}}}{\sem{ \calP(\alpha)}}{\syncat{\textit{B}}}}
\DisplayProof}\\
 & & & \\
{
\ensuremath{\vs} &
...
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp}.  \ptv{b}}}{\sem{ \lambda x. \sF}}{\syncat{\textit{B}\vs \textit{A}}}}
\DisplayProof}
& 
{ 
...
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont the \O documents; \\ \sem{ \iota(\trns{docs})}; \\\syncat{  NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont sent \O the \O documents; \\ \sem{ \trns{send}(\iota(\trns{docs}))}; \\\syncat{  VP/PP\fb{to}}}}
\AxiomC{\MultiLine{\ptfont the; \\ \sem{ \iota}; \\\syncat{  NP/N}}}
\AxiomC{\MultiLine{\ptfont committee; \\ \sem{ \trns{comm} }; \\\syncat{  N}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont the \O committee; \\ \sem{ \iota(\trns{comm})}; \\\syncat{  NP}}}
\AxiomC{\MultiLine{\ptfont to; \\ \sem{ \lambda x.x}; \\\syncat{  PP\fb{to}/NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont to \O the \O committee; \\ \sem{ \iota(\trns{comm})}; \\\syncat{  PP\fb{to}}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont sent \O the \O documents \O to \O the \O committee; \\ \sem{ \trns{send}(\iota(\trns{docs}))(\iota(\trns{comm}))}; \syncat{ VP}}}
\AxiomC{\MultiLine{\ptfont  over; \\ \sem{ \trns{over} }; \\\syncat{  VP\bsl{}VP/NP}}}
\AxiomC{\MultiLine{\ptfont  the; \\ \sem{ \iota}; \\\syncat{  NP/N}}}
\AxiomC{\MultiLine{\ptfont  weekend; \\ \sem{ \trns{wknd} }; \\\syncat{  N}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont the \O weekend; \\ \sem{ \iota(\trns{wknd})}; \syncat{ NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont over \O the \O weekend; \\ \sem{ \trns{over}(\iota(\trns{wknd}))}; \\\syncat{  VP\bsl{}VP}}}
\RightLabel{\scalebox{.8}{\bsl E}}
\BinaryInfC{\MultiLine{\ptfont sent \O the \O documents \O to \O the \O    {}\\ \ptfont   \hspace{3ex}committee \O over \O the \O weekend; \\   \sem{ \trns{over}(\iota(\trns{wknd}))(\trns{send}(\iota(\trns{docs}))(\iota(\trns{comm})))}; \\\syncat{  VP}}}
\AxiomC{\MultiLine{\ptfont john; \\ \sem{ \trns{j} }; \\\syncat{  NP}}}
\RightLabel{\scalebox{.8}{\bsl E}}
\BinaryInfC{\MultiLine{\ptfont john \O sent \O the \O documents \O to \O the \O    {}\\ \ptfont   \hspace{3ex}committee \O over \O the \O weekend; \\   \sem{ \trns{over}(\iota(\trns{wknd}))(\trns{send}(\iota(\trns{docs}))(\iota(\trns{comm})))}; \\\syncat{  S}}}
\DisplayProof
}
\end{exe}
...
string
\pt{john \O sent \O the \O documents \O to \O the \O committee \O over \O the \O weekend}
...
\AxiomC{\LexEnt{\pt{\ensuremath{\greekp}}}{\sem{ x}}{\syncat{NP}}}
\BinaryInfC{\LexEnt{\pt{bought \O p}}{\sem{ \trns{buy}(x)}}{\syncat{VP}}}
\AxiomC{\LexEnt{\pt{john}}{\sem{ \trns{j} }}{\syncat{NP}}}
\BinaryInfC{\LexEnt{\pt{john \O bought \O p}}{\sem{ \trns{buy}(x)(\trns{j})}}{\syncat{S}}}
\UnaryInfC{\LexEnt{\pt{john \O bought}}{\sem{ \lambda x. \trns{buy}(x)(\trns{j})}}{\syncat{S/NP}}}
\DisplayProof
\end{exe}
...
\begin{exe}
 \ex\label{baked}
  \LexEnt{\pt{bill \O baked}}{\sem{ \lambda u. \trns{bake}(u)(\trns{b})}}{\syncat{S/NP}}
\end{exe}
...
\begin{exe}
 \ex\label{rnrSign}
  \LexEnt{\pt{john \O bought \O and \O bill \O baked}}{\sem{ \lambda w. \trns{buy}(w)(\trns{j}) /\f \trns{bake}(w)(\trns{b})}}{\syncat{S/NP}}
\end{exe}
The final step in the proof will then be (\ref{rnrFinal}):

\begin{exe}
 \ex\label{rnrFinal}
\AxiomC{\MultiLine{\ptfont john \O bought \O and \O    {}\\ \ptfont   \hspace{3ex} bill \O baked; \\   \sem{ \lambda w. \trns{buy}(w)(\trns{j}) \ensuremath{ \wedge\xspace } \trns{bake}(w)(\trns{b})}; \\\syncat{  S/NP}}}
\AxiomC{\Lemma}
\UnaryInfC{\MultiLine{\ptfont the \O pizza \O margarita; \\ \sem{ \iota(\trns{pzzmarg})}; \syncat{ NP}}}
\BinaryInfC{\MultiLine{\ptfont john \O bought \O and \O    {}\\ \ptfont   \hspace{3ex}bill \O baked; \\   \sem{  \trns{buy}(\iota(\trns{pzzmarg}))(\trns{j}) \ensuremath{ \wedge\xspace } \trns{bake}(\iota(\trns{pzzmarg}))(\trns{b})}; \\\syncat{  S}}}
\DisplayProof
\end{exe}
...
\AxiomC{\LexEnt{\pt{\ensuremath{\greekp}}}{\sem{ x}}{\syncat{NP}}}
\BinaryInfC{\LexEnt{\pt{gave \O \ensuremath{\greekp}}}{\sem{ \trns{give}(x)}}{\syncat{VP/PP\fb{to}}}}
\AxiomC{\Lemma}
\UnaryInfC{\MultiLine{\ptfont to \O cleopatra; \\ \sem{ \trns{cleop} }; \syncat{ PP\fb{to}}}}
\BinaryInfC{\LexEnt{\pt{gave \O \ensuremath{\greekp} \O to \O cleopatra}}{\sem{ \trns{give}(x)(\trns{cleop})}}{\syncat{VP}}}
\AxiomC{\LexEnt{\pt{antony}}{\sem{ \trns{ant} }}{\syncat{NP}}}
\BinaryInfC{\LexEnt{\pt{antony \O gave \O \ensuremath{\greekp} \O to \O cleopatra}}{\sem{ \trns{give}(x)(\trns{cleop})(\trns{ant})}}{\syncat{S}}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp}.antony \O gave \O \ensuremath{\greekp} \O to \O cleopatra}}{\sem{ \lambda x. \trns{give}(x)(\trns{cleop})(\trns{ant})}}{\syncat{S\vs NP}}}
\DisplayProof
\end{exe}
...
\begin{exe}
 \ex\label{gaveTerm}
  \LexEnt{\pt{ \ensuremath{\lambda} \ensuremath{\greekp}. john \O gave \O \ensuremath{\greekp} \O that \O book}}{\sem{ \lambda x. \trns{gave}(x)(\iota(\trns{book}))}}{\syncat{S\vs NP }}
\end{exe}
...
\pt{\ensuremath{\lambda} \ensuremath{\greekp}. john \O gave \O \ensuremath{\greekp} \O that \O book} is a string-to-string
...
\begin{exe}
 \ex\label{someoneEntry}
  \LexEnt{\pt{ \ensuremath{\lambda} \ensuremath{\greeks}. \ensuremath{\greeks}(someone)}}{\sem{ \lambda P. \trns{\raisebox{1.5ex}{\ensuremath{\rotatebox{180}{\textbf{E}}}}}(\trns{person})(P)}}{\syncat{S\vs (S\vs NP) }}
\end{exe}
...
\AxiomC{\Lemma}
\UnaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greekp}. john \O gave \O \ensuremath{\greekp} \O that \O book; \\ \sem{ \lambda x. \trns{gave}(x)(\iota(\trns{book}))}; \syncat{ S\vs NP}}}
\AxiomC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greeks}. \ensuremath{\greeks}(someone)}}{\sem{ \lambda P. \trns{\raisebox{1.5ex}{\ensuremath{\rotatebox{180}{\textbf{E}}}}}(\trns{person})(P)}}{\syncat{S\vs (S\vs NP)}}}
\BinaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greeks} [\ensuremath{\greeks}(someone)](\lambda \ensuremath{\greekp}. john \O gave \O \ensuremath{\greekp} \O that \O book); \\ \sem{ \lambda P[ \trns{\raisebox{1.5ex}{\ensuremath{\rotatebox{180}{\textbf{E}}}}}(\trns{person})(P)](\lambda x. \trns{gave}(x)(\iota(\trns{book})))}; \syncat{ S}}}
\dottedLine
\RightLabel{\mbox{\tiny{$\beta$}-conversion}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp} [john \O gave \O \ensuremath{\greekp} \O that \O book](someone)}}{\sem{ \trns{\raisebox{1.5ex}{\ensuremath{\rotatebox{180}{\textbf{E}}}}}(\trns{person})(\lambda x. \trns{gave}(x)(\iota(\trns{book})))}}{\syncat{S}}}
\dottedLine
\RightLabel{\mbox{\tiny{$\beta$}-conversion}}
\UnaryInfC{\LexEnt{\pt{john \O gave \O someone \O that \O book)}}{\sem{ \trns{\raisebox{1.5ex}{\ensuremath{\rotatebox{180}{\textbf{E}}}}}(\trns{person})(\lambda x. \trns{gave}(x)(\iota(\trns{book})))}}{\syncat{S}}}
\DisplayProof
\end{exe}
...
rules in (\ref{rules}) (see \citet{kubotalevineBook}, \textsection{2.3} for
details).
...
phenomena, one of which is considered in detail in \textsection{3} as
...
\begin{exe}
 \ex\label{VPdeletion}
  John likes pizza, but Bill doesn't [\ensuremath{_{\mbox{\tiny\rm VP}}} \sout{like pizza}]
\end{exe}
...
\begin{exe}
 \ex\label{pseudodeletion}
  John eats way more junk food than he does [\ensuremath{_{\mbox{\tiny\rm VP}}} [\ensuremath{_{\mbox{\tiny\rm VP}}} \sout{eat} {\gp}\xspace ] real food]
\end{exe}
...
%%\subsubsection{Muskens on extraction}\label{subsubsec:Muskens}
...
\begin{exe}
 \ex\label{bookProof1}
\AxiomC{\LexEnt{\pt{lost}}{\sem{ \lambda x \lambda y \trns{lose}(x)(y)}}{\syncat{(NP\bsl{}S)/NP}}}
\AxiomC{\ensuremath{[\LexEnt{\pt{\ensuremath{\greekp_0}}}{\sem{ u}}{\syncat{NP}}]^1\,\,}}
\BinaryInfC{\LexEnt{\pt{lost \O \ensuremath{\greekp_0}}}{\sem{ \lambda y \trns{lose}(u)(y)}}{\syncat{NP\bsl{}S}}}
\AxiomC{\LexEnt{\pt{yesterday}}{\sem{ \lambda P \lambda v.yst(P)(v) }}{\syncat{(NP\bsl{}S)\bsl{}(NP\bsl{}S)}}}
\BinaryInfC{\MultiLine{\ptfont lost \O \ensuremath{\greekp_0} \O yesterday; \\ \sem{ \lambda v. \trns{yst}(\trns{lose}(u))(v)}; \syncat{ NP\bsl{}S}}}
\AxiomC{\MultiLine{\ptfont john; \\ \sem{ \trns{j} }; \\\syncat{  NP}}}
\BinaryInfC{\LexEnt{\pt{john \O lost \O \ensuremath{\greekp_0}}}{\sem{ \trns{yst}(\trns{lose}(u))(\trns{j})}}{\syncat{S}}}
\LeftLabel{\maru{1}\ensuremath{\rightarrow}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp_0}. john \O lost \O \ensuremath{\greekp_0} \O yesterday}}{\sem{ \lambda u.  \trns{yst}(\trns{lose}(u))(\trns{j})}}{\syncat{S\vs NP}}}
\DisplayProof
\end{exe}
...
\begin{exe}
 \ex\label{bookProof2}
\end{exe}
\AxiomC{\MultiLine{\ptfont \lambda \ensuremath{\greeks}. which \O \ensuremath{\greeks}(\E); \\ \sem{ \lambda P \lambda Q \lambda w. P(w) \ensuremath{ \wedge\xspace } Q(w)}; \\\syncat{  (N\bsl{}N)\vs (S\vs NP)}}}
\AxiomC{\MultiLine{\ptfont \lambda \ensuremath{\greekp_0}. john \O lost \O \ensuremath{\greekp_0} \O yesterday; \\ \sem{ \lambda u  \trns{yst}(\trns{lose}(u))(\trns{j})}; \\\syncat{  S\vs NP}}}
\BinaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greeks} [which \O \ensuremath{\greeks}(\E)](\lambda \ensuremath{\greekp_0}. john \O lost \O \ensuremath{\greekp_0} \O yesterday); \\ \sem{ \lambda P [ \lambda Q \lambda x. P(w) \ensuremath{ \wedge\xspace } Q(w)](\lambda u  \trns{yst}(\trns{lose}(u))(\trns{j}))}; \\\syncat{  N\bsl{}N}}}
\dottedLine
\UnaryInfC{\LexEnt{\pt{which \O \ensuremath{\lambda} \ensuremath{\greekp_0} [john \O lost \O \ensuremath{\greekp_0} \O yesterday](\E)}}{\sem{ \lambda Q. [ \lambda w.  \trns{yst}(\trns{lose}(w))(\trns{j}) \ensuremath{ \wedge\xspace } Q(w)]}}{\syncat{N\bsl{}N}}}
\dottedLine
\UnaryInfC{\LexEnt{\pt{which \O john \O lost \O \E \O yesterday}}{\sem{ \lambda Q [ \lambda w.  \trns{yst}(\trns{lose}(w))(\trns{j}) \ensuremath{ \wedge\xspace } Q(w)]}}{\syncat{N\bsl{}N}}}
\DisplayProof
...
\AxiomC{\LexEnt{\pt{which \O john \O lost \O \E \O yesterday}}{\sem{ \lambda Q [ \lambda w.  \trns{yst}(\trns{lose}(w))(\trns{j}) \ensuremath{ \wedge\xspace } Q(w)]}}{\syncat{N\bsl{}N}}}
\BinaryInfC{\LexEnt{\pt{book \O  which \O john \O lost \O \E \O yesterday}}{\sem{  \lambda w.  \trns{yst}(\trns{lose}(w))(\trns{j}) \ensuremath{ \wedge\xspace } \trns{book}(w)]}}{\syncat{N}}}
\DisplayProof
\end{exe}
...
\begin{exe}
 \ex\label{length}
\AxiomC{\MultiLine{\ptfont mary \O thinks \O bill \O remembers \O ann \O saying \O john \O lost \O \ensuremath{\greekp}; \\ \sem{ \trns{think}(\trns{remember}(\trns{saying}(\trns{yest}(\trns{lost}(u))(\trns{j}))(\trns{a})))(\trns{b})))(\trns{m})}; \\\syncat{  S}}}
\UnaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greekp}. mary \O thinks \O bill \O remembers \O ann \O saying \O john \O lost \O \ensuremath{\greekp}; \\ \sem{ \trns{think}(\trns{remember}(\trns{saying}(\trns{yest}(\trns{lost}(u))(\trns{j}))(\trns{a})))(\trns{b})))(\trns{m})}; \\\syncat{  S}}}
\DisplayProof
\end{exe}
...
the model theory for the prosodic calculus interprets \ptv{a \O b \O \E} as
...
\begin{exe}
 \ex\label{ellipseOp1}
  ...
  \LexEnt{\pt{ \ensuremath{\lambda} \ensuremath{\greekp}. \ensuremath{\greekp} }}{\sem{ \lambda \ensuremath{\mathscr{F}}. \ensuremath{\mathscr{F}}(P')}}{\syncat{(NP\bsl{}S)\vs ((NP\bsl{}S)\vs (NP\bsl{}S) }}
...
\begin{tabular}{ll}
 \scalebox{.8}{
\AxiomC{\MultiLine{\ptfont should ; \\ \sem{ \lambda Q \lambda y. \ensuremath{\square} Q(y)}; \\\syncat{   (NP\bsl{}S)/(NP\bsl{}S)}}}
\AxiomC{\MultiLine{\ptfont call; \\ \sem{ \trns{call} }; \\\syncat{  (NP\bsl{}S)/NP}}}
\AxiomC{\MultiLine{\ptfont ann; \\ \sem{ \trns{a} }; \\\syncat{  NP}}}
\LeftLabel{\maru{1}\ensuremath{\rightarrow}}
\BinaryInfC{\MultiLine{\ptfont call \O ann; \\ \sem{ \trns{call}(\trns{a})}; \\\syncat{  NP\bsl{}S}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont should \O call \O ann ; \\ \sem{ \lambda y. \ensuremath{\square} \trns{call}(\trns{a})(y)}; \\\syncat{  NP\bsl{}S}}}
\AxiomC{\LexEnt{\pt{mary}}{\sem{ \trns{m} }}{\syncat{NP}}}
\RightLabel{\scalebox{.8}{\bsl E}}
\BinaryInfC{\MultiLine{\ptfont mary \O should \O call \O ann ; \\ \sem{  \ensuremath{\square} \trns{call}(\trns{a})(\trns{m})}; \\\syncat{  S}}}
\DisplayProof}
 &
 \scalebox{.8}{ 
\AxiomC{\MultiLine{\ptfont bill ; \\ \sem{ \trns{b} }; \\\syncat{  NP}}}
\RightLabel{per \ding{172}}
\AxiomC{\grey{\MultiLine{\ptfont \lambda \ensuremath{\greekp}. \ensuremath{\greekp} ; \\ \sem{ \lambda \ensuremath{\mathscr{F}}. \ensuremath{\mathscr{F}}(\trns{call}(\trns{a}))}; \\\syncat{  (NP\bsl{}S)\vs (NP\bsl{}S/NP\bsl{}S)}}}}
\AxiomC{\MultiLine{\ptfont  should't ; \\ \sem{ \lambda P \lambda y. \neg \ensuremath{\square}\, P(y)}; \\\syncat{  (NP\bsl{}S)/(NP\bsl{}S)}}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}E}}
\BinaryInfC{\LexEnt{\pt{should't }}{\sem{ \lambda y. \neg \ensuremath{\square}\, \trns{call}(y)()}}{\syncat{ NP\bsl{}S}}}
\RightLabel{\scalebox{.8}{\bsl E}}
\BinaryInfC{\LexEnt{\pt{bill \O should't }}{\sem{  \neg \ensuremath{\square}\, \trns{call}(\trns{a})(\trns{b})}}{\syncat{S}}}
\DisplayProof}
\end{tabular}
\end{exe}
...
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\LexEnt{\pt{\ensuremath{\greekp_2} \O \ensuremath{\greekp_1}}}{\sem{  R(u)}}{\syncat{VP}}}
\AxiomC{\grey{\LexEnt{\pt{\ptv{a}}}{\sem{ \lambda T. \lambda z.\bigcirc T(z) }}{\syncat{VP/VP}}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\LexEnt{\pt{\ptv{a} \O \ensuremath{\greekp_2} \O \ensuremath{\greekp_1}}}{\sem{ \lambda z. \bigcirc \,R(u)(z))}}{\syncat{VP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}I\ensuremath{^1}}}
\UnaryInfC{\LexEnt{\pt{\ptv{a} \O \ensuremath{\greekp_2}}}{\sem{ \lambda u \lambda z. \bigcirc \,R(u)(z)}}{\syncat{VP/NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}I\ensuremath{^2}}}
\UnaryInfC{\grey{\LexEnt{\pt{\ptv{a}}}{\sem{ \lambda R \lambda u \lambda z. \bigcirc \,R(u)(z)}}{\syncat{(VP/NP)/(VP/NP)}}}}
\DisplayProof
\end{exe}
...
\begin{exe}
 \ex\label{generalized}
  ...
  \pt{\ensuremath{\lambda} \ensuremath{\greekp}. \ensuremath{\greekp} }; \sem{ \lambda \ensuremath{\mathscr{F}}. \ensuremath{\mathscr{F}}(P) }; VP\$\ensuremath{\vs}(VP\$/VP\$)
...
\begin{tabular}{ll}
{\scalebox{.75}{
\AxiomC{\MultiLine{\ptfont will; \\ \sem{ \lambda P \lambda y.\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{ILL}}}\, P(y)}; \\\syncat{  VP/VP}}}
\AxiomC{\grey{\MultiLine{\ptfont read; \\ \sem{ \trns{read} }; \\\syncat{  VP/NP}}}}
\AxiomC{  essays}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont read \O essays; \\ \sem{ \trns{read}(\trns{essays})}; \\\syncat{  VP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont will \O read \O essays; \\ \sem{  \lambda y.\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{ILL}}}\, \trns{read}(\trns{essays})(y)}; \\\syncat{  VP}}}
\AxiomC{\MultiLine{\ptfont john; \\ \sem{ \trns{j} }; \\\syncat{  NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{/}E}}
\BinaryInfC{\MultiLine{\ptfont john \O will \O read \O essays; \\ \sem{ \textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{ILL}}}\, \trns{read}(\trns{essays})(\trns{j})}; \\\syncat{  S}}}
\DisplayProof
}}
&
\hspace{-6ex}
{\scalebox{.75}{
\AxiomC{\LexEnt{\pt{won't}}{\sem{ \lambda Q [L u \lambda v.\neg\,\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{ILL}}} Q(u)(v)](P')}}{\syncat{VP/NP}}}
\dottedLine
\UnaryInfC{\LexEnt{\pt{won't}}{\sem{ \lambda u \lambda v.\neg\,\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{ILL}}} P'(u)(v)}}{\syncat{VP/NP}}}
\dottedLine
...
\BinaryInfC{\LexEnt{\pt{\ensuremath{\greekp_1} \O \ensuremath{\greeks_1}(\ensuremath{\greekp_2})}}{\sem{ \ensuremath{\mathscr{O}}(f(x))}}{\syncat{VP}}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}I\ensuremath{^2}}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp_2}. \ensuremath{\greekp_1} \O \ensuremath{\greeks_1}(\ensuremath{\greekp_2})}}{\sem{ \lambda x. \ensuremath{\mathscr{O}}(f(x))}}{\syncat{VP\vs NP}}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}I\ensuremath{^1}}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greeks_1} \ensuremath{\lambda} \ensuremath{\greekp_2}. \ensuremath{\greekp_1} \O \ensuremath{\greeks_1}(\ensuremath{\greekp_2})}}{\sem{ \lambda f \lambda x. \ensuremath{\mathscr{O}}(f(x))}}{\syncat{(VP\vs NP)\vs (VP\vs NP)}}}
\DisplayProof
\end{exe}
...
%%\footnote{One might wonder whether this
%%operator needs to be further generalized via a vertical-slash
%%version of \$. We will not address this question here. NB: \textit{There are
%%certain issues which I know I can talk to Bill about and there are
%%others I know I can talk to Mary about, but there
%%are certain topics which I'm never quite sure \textsc{who} I can.}}

\begin{exe}
 \ex\label{zzzz}
  \LexEnt{\pt{ \ensuremath{\lambda} \ensuremath{\greekr} \ensuremath{\lambda} \ensuremath{\greekp_1}. \ensuremath{\greekr}(\ensuremath{\lambda} \ensuremath{\greekp_0}. \ensuremath{\greekp_0})(\ensuremath{\greekp_1})}}{\sem{ \lambda \ensuremath{\mathscr{F}}. \ensuremath{\mathscr{F}}(R\,')}}{\syncat{(VP\vs NP)\vs ((VP\vs NP)\vs (VP\vs NP)) }}
...
\UnaryInfC{\Lemma}
\noLine
\UnaryInfC{\MultiLine{\ptfont ate \O \ensuremath{\greekp_1} \O for \O lunch; \\ \sem{ \trns{ate}(x)(\trns{lunch})}; \syncat{ VP}}}
\LeftLabel{\maru{1}\ensuremath{\rightarrow}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}I\ensuremath{^1}}}
\UnaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greekp_1}.ate \O \ensuremath{\greekp_1} \O for \O lunch; \\ \sem{ \mbox{\grey{\sem{ \lambda x. \trns{ate}(x)(\trns{lunch}) }}} }; \syncat{ VP\vs NP}}}
\AxiomC{\ensuremath{\ThreeColHyp{\MultiLine{\ptfont \ensuremath{\greekp_2}; \\ \sem{ u}; \\\syncat{  NP}}}^2}}
\BinaryInfC{\LexEnt{\pt{ate \O \ensuremath{\greekp_2} \O for \O lunch}}{\sem{ \trns{ate}(u)(\trns{lunch})}}{\syncat{VP}}}
\AxiomC{\MultiLine{\ptfont john; \\ \sem{ \trns{j} }; \\\syncat{  NP}}}
\BinaryInfC{\LexEnt{\pt{john \O ate \O \ensuremath{\greekp_2} \O for \O lunch}}{\sem{ \trns{ate}(u)(\trns{lunch})(\trns{j})}}{\syncat{S}}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}I\ensuremath{^2}}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp_2}. john \O ate \O \ensuremath{\greekp_2} \O for \O lunch}}{\sem{ \lambda u. \trns{ate}(u)(\trns{lunch})(\trns{j})}}{\syncat{S\vs NP}}}
\AxiomC{\MultiLine{\ptfont \lambda \ensuremath{\greeks}. what \O \ensuremath{\greeks}(\E); \\ \sem{  \lambda P. \trns{what}(P) }; \\\syncat{  Q\vs (S\vs NP)}}}
\BinaryInfC{\LexEnt{\pt{what \O john \O ate \O \E \O for \O lunch}}{\sem{ \trns{what}(\lambda u. \trns{ate}(u)(\trns{lunch})(\trns{j}))}}{\syncat{Q}}}
\DisplayProof
\end{exe}
\noindent The grayed-in semantic term in (\ref{part1}) is an available predicate
with which the free variable $R\,'$ obtained in the proof line \maru{1}
...
\AxiomC{\Lemma}
\UnaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greeks} \lambda \ensuremath{\greekp}. did \O \ensuremath{\greeks}(\ensuremath{\greekp}); \\ \sem{ \lambda f \lambda x \lambda y. f(x)(y)}; \\\syncat{  (VP\vs NP)\vs (VP\vs NP)}}}
\AxiomC{\MultiLine{\ptfont \lambda \ensuremath{\greekr} \lambda \ensuremath{\greekp}. \ensuremath{\greekr}(\lambda \ensuremath{\greekp_0}. \ensuremath{\greekp_0})(\ensuremath{\greekp}); \\ \sem{ \lambda \ensuremath{\mathscr{F}}. \ensuremath{\mathscr{F}}(\lambda x. \trns{ate}(x)(\trns{lunch}))}; \\\syncat{  (VP\vs NP)\vs }\\ \hspace{2ex}\syncat{((VP\vs NP)\vs (VP\vs NP))}}}
\BinaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp}.did \O \ensuremath{\greekp}}}{\sem{ \lambda x \lambda y. \trns{ate}(x)(\trns{lunch})(y)}}{\syncat{VP\vs NP}}}
\AxiomC{\ensuremath{\ThreeColHyp{\MultiLine{\ptfont \ensuremath{\greekp_3}; \\ \sem{ v}; \\\syncat{  NP}}}^3}}
\BinaryInfC{\LexEnt{\pt{did \O \ensuremath{\greekp_3}}}{\sem{ \lambda y. \trns{ate}(v)(\trns{lunch})(y)}}{\syncat{VP}}}
\AxiomC{\MultiLine{\ptfont bill; \\ \sem{ \trns{b} }; \\\syncat{  NP}}}
\BinaryInfC{\LexEnt{\pt{bill \O did \O \ensuremath{\greekp_3}}}{\sem{ \trns{ate}(v)(\trns{lunch})(\trns{b})}}{\syncat{S}}}
\RightLabel{\scalebox{.8}{\ensuremath{\vs}I\ensuremath{^3}}}
\UnaryInfC{\LexEnt{\pt{\ensuremath{\lambda} \ensuremath{\greekp_3}. bill \O did \O \ensuremath{\greekp_3}}}{\sem{ \lambda v. \trns{ate}(v)(\trns{lunch})(\trns{b})}}{\syncat{S\vs NP}}}
\DisplayProof
\end{exe}
...
\pt{\ensuremath{\lambda} \ensuremath{\greekp_3}. bill \O did \O \ensuremath{\greekp_3}}, is exactly what we would have obtained via
...
\BinaryInfC{\LexEnt{\pt{did \O breakfast}}{\sem{ \lambda y. \trns{ate}(x)(\trns{brkfst})(y)}}{\syncat{VP}}}
\AxiomC{\LexEnt{\pt{he}}{\sem{ 3masc }}{\syncat{S}}}
\BinaryInfC{\LexEnt{\pt{he \O did \O breakfast}}{\sem{ \trns{ate}(\trns{brkfst})(3masc)}}{\syncat{S}}}
\DisplayProof
\end{exe}
...
\BinaryInfC{\MultiLine{\ptfont buy \O \ensuremath{\greekp_1}; \\ \sem{ \trns{buy}(x)}; \\\syncat{  VP}}}
\UnaryInfC{\MultiLine{\ptfont \lambda \ensuremath{\greekp_1}. buy \O \ensuremath{\greekp_1}; \\ \sem{ \mbox{\grey{\sem{ \lambda x. \trns{buy}(x) }}} }; \\\syncat{  VP\vs NP}}}
\AxiomC{\Lemma}
\UnaryInfC{\MultiLine{\ptfont this \O kind \O of \O sports \O car; \\ \sem{ \iota(\trns{kind}(\trns{spcr}))}; \\\syncat{  NP}}}
\BinaryInfC{\MultiLine{\ptfont buy \O this \O kind \O of \O sports \O car; \\ \sem{ \trns{buy}(\iota(\trns{kind}(\trns{spcr})))}; \\\syncat{  VP}}}
\AxiomC{\MultiLine{\ptfont would; \\ \sem{ \lambda P \lambda y.\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{D}}}\, P(y)}; \\\syncat{  VP/VP}}}
\BinaryInfC{\MultiLine{\ptfont would \O buy \O this \O kind \O of \O sports \O car; \\ \sem{ \lambda y.\textrm{\textbf{W}}\scalebox{.75}{\textrm{\textbf{D}}}\,\trns{buy}(\iota(\trns{kind}(\trns{spcr})))(y)}; \\\syncat{  VP}}}
\DisplayProof
\end{exe}
...
\citet{kubotalevineBook}, \textsection{8.4.2}.} There is, on the analysis
...
\textsection{3.1.2} the auxiliary \textit{did} in (\ref{extrac-from-VPE}) is a VP
...
there is a Galois connection between $f^\ast$ and $f^\ast {\rm\,
...
%%.. word; L x. meaning(x) ; (NP\S)/PP\fb{for}

%%.. word; L x. meaning(x) ; (be\S)/al

\bibliographystyle{mybst} 
\bibliography{mybib-new}
\end{document}
***

%= ABBREVIATORY NOTATIONS
%
%An rdx has the following general structure:
%
%------------------------------------
%
%(i) Main body 
...
%------------------------------------
%
%(ii) Recipe for Perl code 
%
%------------------------------------
%
%(iii) Recipe for the LaTeX preamble
%
%------------------------------------
%
%What follows corresponds to part (ii) in this general structure.
%
%Note in particular that in this part, what you write is \emph{perl} code
%fragments (or abbreviations for code fragments), and NOT LaTeX code
%fragments. So, the notational conventions follow that of perl. In
%particular, comments should be prefixed by #, and NOT %.
%
%There are four sections in this part: 
%
%- simple arrow: 
%This is for abbreviatory notations written in the simple A \ensuremath{ \Rightarrow } B
%format. You don't need to escape the backslashes here since that's
%automatically taken care of by the preprocessor. Expansion is done
%*before* all the other .rdx \ensuremath{ \Rightarrow } .tex expansions. If you want to
%write an expansion definition for the syntactic category part of 
%linguistic expressions, write it in the `simple arrow post' 
%(see below) section rather than in this section.
%
%- simple arrow post
%Same as `simple arrow' except that expansion is done \emph{after} all the
%other .rdx \ensuremath{ \Rightarrow } .tex expansions. When you want to write an expansion
%definition for the syntactic category part of linguistic
%expressions, this is the right place to put the definition.
%
%- replace:       
%Here, you write perl code for replacing string based on regular
%expression. Since this is real perl code, you need to quote the
%backslash, which means you need to write \\ instead of \. The notation
%is more cumbersome as compared to the `simple arrow' part, but it
%allows for greater flexibility by making full use of perl regular
%expressions. Expansion is done \emph{before} all the other .rdx \ensuremath{ \Rightarrow } .tex
%expansions.
%
%- replace post: 
%Same as `replace' except that expansion is done \emph{after} all the
%other .rdx \ensuremath{ \Rightarrow } .tex expansions.
%
...
\PARA{In most cases, it suffices to write abbreviations in this part.  }
\PARA{See below for some examples.}

\PARA{box and diamond (e.g., for the necessity and possibility modalities)}
\ensuremath{\square} \ensuremath{ \Rightarrow } \ensuremath{\square}
\ensuremath{\Diamond} \ensuremath{ \Rightarrow } \ensuremath{\Diamond}

\PARA{words that should almost always appear uppercase in the output}
RNR \ensuremath{ \Rightarrow } RNR
NCC \ensuremath{ \Rightarrow } NCC
CCG \ensuremath{ \Rightarrow } CCG
CG \ensuremath{ \Rightarrow } CG
LBE \ensuremath{ \Rightarrow } LBE
OQM \ensuremath{ \Rightarrow } OQM
HPSG \ensuremath{ \Rightarrow } HPSG
TLCG \ensuremath{ \Rightarrow } TLCG
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
>simple noquote arrow post

\textrm{\textbf{I}}\scalebox{.7}{\textrm{\textbf{NV}}} \ensuremath{ \Rightarrow } \textrm{\textbf{I}}\scalebox{.75}{\textrm{\textbf{NV}}}

\textrm{\textbf{E}}\scalebox{.7}{\textrm{\textbf{LL}}} \ensuremath{ \Rightarrow } \textrm{\textbf{E}}\scalebox{.75}{\textrm{\textbf{LL}}}

\textrm{\textbf{N}}\scalebox{.7}{\textrm{\textbf{EG}}} \ensuremath{ \Rightarrow } \textrm{\textbf{N}}\scalebox{.75}{\textrm{\textbf{EG}}}

\textrm{\textbf{S}}\scalebox{.7}{\textrm{\textbf{HOULD}}} \ensuremath{ \Rightarrow } \textrm{\textbf{S}}\scalebox{.75}{\textrm{\textbf{HOULD}}}

\textrm{\textbf{S}}\scalebox{.7}{\textrm{\textbf{HOULDN}\textsf{'}\textbf{T}}} \ensuremath{ \Rightarrow } \textrm{\textbf{S}}\scalebox{.75}{\textrm{\textbf{HOULDN}\textsf{`}\textbf{T}}}

\textrm{\textbf{D}}\scalebox{.7}{\textrm{\textbf{O}}} \ensuremath{ \Rightarrow } \textrm{\textbf{D}}\scalebox{.75}{\textrm{\textbf{O}}}
