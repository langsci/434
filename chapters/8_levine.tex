...
\BinaryInfC{\MultiLine{\texttt{john \circ \ bought \circ \ and \circ    {}}\\ \texttt{  \hspace{3ex}bill \circ \ baked \circ \ the \circ \ pizza \circ \ margherita;} \\   \sem{  \trns{buy}(\iota(\trns{pzzmarg}))(\trns{j}) \ensuremath{ \wedge\xspace } \trns{bake}(\iota(\trns{pzzmarg}))(\trns{b})}; \\\syncat{  S}}}
\DisplayProof
\end{exe}
