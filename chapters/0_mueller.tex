...
But what is described in the movie \emph{Grammar of happiness} \citew{OW2012a} and even more clearly in \citew{Pullum2023a} this volume is
exactly the opposite. Chomsky and others made a statement that all languages may license infinitely
many utterances in principle (\citealt*[\page 1571]{HCF2002a}, \citealt[\page 4]{EH2005a-u}, \citealt*[\page
7]{HNG2005a}) and there are several languages that seem to contradict this claim (see
\citew[Section~\ref{sec-Oxford-cancelation}]{Pullum2023a} for a recent overview). Instead of
...
build. See \citew{Wasow2021a} and \citet{BM2021a} for psycholinguistic facts and criticism of the
...
10.000€ that are usually charged by profit-oriented publishers.\itdopt{Add reference to Sebastians
  blog post about prices.}
...
counter example. (See \citew{Pullum2023a} for a list of putatively finite languages.) If it is stated that Subjacency is a principle that holds for all languages, then
...
languages. See \citew{Fanselow2004b} for some criticism towards this end.
