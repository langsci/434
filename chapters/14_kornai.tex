...
\author{Andr\'as Kornai}%\affiliation{Budapest University of Technology and Economics}}
\title{What is the simplest semantics imaginable?}
\usepackage{tabularx}
\usepackage{langsci-optional}
\usepackage{langsci-gb4e}
%\usepackage[backend=biber, bibencoding=utf8, natbib,style=authoryear,uniquename=false,uniquelist=false]{biblatex}
...
%operate with just {\it Move} and {\it Merge}? 
...
What makes us uniquely human? Chomsky says our genes



De Libertatae Arbitrii Bonum

``On the freedom of good will''

It is only subsumption that has a trivial translation in the
vectorial setup (where it will correspond to the ordinary subset `$\subset$'
relation) a
