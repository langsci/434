...
In Section \sectref{expect} we set expectations by discussing some important
...
Section \sectref{4lang}, where we return to the issue whether there is, or should
...
Fig.~\figref{fig:information_objects}, with the primary attention focused on the
...
meaning by compositional means as possible. In Section \sectref{4lang} we offer a
...
Section \sectref{4lang} we will considerably relax D4 and D5: whatever is OTF,
...
return to in Section \sectref{4lang}.
...
%operate with just \emph{Move} and \emph{Merge}? 
