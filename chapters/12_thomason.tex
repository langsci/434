...
\gll {k\textsuperscript w}u m\'aw-{\textltilde}t-\'es in-p'uy-p'\'uy=\v{s}n\\
     1sg.\textsc{obj} break-\textsc{rel.trans}-3.\textsc{trans.subj} 1sg.\textsc{poss}-\textsc{redup:}plu.-wrinkle=foot \\
...
\ea K\textsuperscript w \textglotstop\'im'\v{s}.  \\
\gll k\textsuperscript w \textglotstop\'im'\v{s}\\
2sg.\textsc{intr.subj} move(camp)\\  
\glt `You moved.'
\z

\ea \v{C}n {q\textsuperscript w}oy\'ulex\textsuperscript w.  \\
...
\ea {\textglotstop}ocq\'e{\textglotstop} ({\textltilde}u)  \v{C}on\'i. \\
...
\ea {K\textsuperscript w}u p\'ul{\textltilde}tm is{k\textsuperscript w}\'is{k\textsuperscript w}s. \\
...
\ea Qe n\v{c}cn\'i\v{c}i{\textltilde}lt t s\v{c}q'i{q'\textsuperscript w}\'e.  \\
...
\ea Wic\'inm{\textltilde}ts ask\textsuperscript w\'is{k\textsuperscript w}s. \\
...
\ea {K\textsuperscript w} ya{\textglotstop}m\'im. \\
...
\ea \v{c}n x\textsuperscript w\'uy \\
\gll \v{c}n x\textsuperscript w\'uy \\
1sg.\textsc{intr.subj} go \\
\glt `I go'
\z

\ea \v{c}x\textsuperscript w\'uymn \\
...
\ea {K\textsuperscript w} plsq\'e t \v{s}m\'en'. \\
...
\ea Nt{\d{x}\textsuperscript w}msq\'a t \d{x}{\textcrlambda}'c\'is. \\
...
\ea \v{C}n ct'ipmnc\'u tl' es\v{s}\'it'.  \\
...
\ea Qsnc\'u {\textltilde}u \v{C}on\'i. \\
...
\ea {K\textsuperscript w}u \v{c}ta{\d{x}\textsuperscript w}lmnc\'utmntm. \\
...
\itdopt{Put the following in the table above unless it is LGR.}
