...
\label{thomason_section_1}
  ...
  of these differences (Section \sectref{thomason_section_3}).  We adopt, with modifications, the
  ...
  (See Section \sectref{thomason_section_2.4} for a brief explanation of valency in
  ...
  forms as transitives, not intransitives (Section \sectref{thomason_section_2.7}).
...
object markers; these will be discussed in Section \sectref{thomason_section_2.6}.  Third-person
...
\label{thomason_section_2.1}
  ...
  nondistinctive variants (and see Section \sectref{thomason_section_3} for some discussion of the
...
discussed in Section \sectref{thomason_section_2.6} and illustrated in examples \REF{ex-thomason-41}--\REF{ex-thomason-44} below.)
...
discussion in Section \sectref{thomason_section_3} below).  The antipassive also serves as the usual
...
relevant to our overall analysis of these two patterns (see Section \sectref{thomason_section_3}
below).
...
Section \sectref{thomason_section_2.1}) semantically because it typically has an indefinite patient,
and in any case its agent is the main focus.  As we will argue in Section \sectref{thomason_section_3}, this transitivity-reducing function unites the antipassive suffix
with the backgrounded agent suffix (Section \sectref{thomason_section_2.5}) and the transitive
continuative suffix (Section \sectref{thomason_section_2.6}).
...
suffix -- {-\emph{nt}}, -\emph{st}, or relational (ditransitive) -\emph{{\textltilde}t} or -\emph{\v{s}it}.\footnote{But see Section \sectref{thomason_section_2.6} below:
...
return to this topic in Section \sectref{thomason_section_3}.
...
discuss this further in Section \sectref{thomason_section_3}.
...
suffix, or the transitive continuative suffix (see Section \sectref{thomason_section_2.6} above).
...
causative stem, as we saw in Section \sectref{thomason_section_2.4}.  As a reminder of that
...
Section \sectref{thomason_section_2.4}, a form \emph{\v{c}n xw\'uym} `I make someone go' is also
...
Section \sectref{thomason_section_2} fit
