...
discussed in Section~2.9 and illustrated in examples \REF{ex-thomason-41}--\REF{ex-thomason-44} below.)
...
(see e.g. Sections~2.8-9 below, especially example \REF{ex-thomason-44}, in which the derived
