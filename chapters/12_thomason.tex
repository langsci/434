...
\itdopt{Fix all quotations. Single quotes = glossing, double quotes = quotes/distancing.}
...
\subsection{Ordinary transitive verbs}  %2.1
  ...
  Ordinary transitive verbs, illustrated in exx. \ref{ex-thomason-1}--\ref{ex-thomason-6}, are aspectually
  ...
  exx. \ref{ex-thomason-1}--\ref{ex-thomason-6} are bare roots, with the exception of \ref{ex-thomason-6}.  Ex. \ref{ex-thomason-6} consists
  ...
  suffix---and similarly for the few lexical prefixes, e.g. \emph{pu\textglotstop}= `spouse' in ex. \ref{ex-thomason-20}.}
...
\itdopt{use latex reference mechanism (labels and \backslash REF) use `--' rather than
  `-' for regions}
...
Exx. \ref{ex-thomason-7}--\ref{ex-thomason-10} illustrate the second relevant construction type,
...
are often used interchangeably.  Exx. \ref{ex-thomason-7}--\ref{ex-thomason-10}are all formed to bare
...
\z
\itdopt{what is ``plu.''? For Sebastian: Why is there so much space below the glosses? sg/pl should be
done according to the Leipzig Glossing Rules.}


\subsection{Plain intransitive verbs}  %2.3

Plain intransitive verbs, illustrated in exx. \ref{ex-thomason-11}--\ref{ex-thomason-13}, stand in sharp
...
discussed in Section~2.9 and illustrated in exx. \ref{ex-thomason-41}--\ref{ex-thomason-44} below.)
...
exx. \ref{ex-thomason-14}--\ref{ex-thomason-17}, we see more complicated relations between morphosyntax and
...
transitive constructions, as in exx. \ref{ex-thomason-1}--\ref{ex-thomason-6} above.  Antipassives, by
...
\emph{{\textltilde}u}, as in ex. \ref{ex-thomason-16} (for which the free translation is
...
indefinite but sometimes definite, as in ex. \ref{ex-thomason-16}.  When the object is
...
obligatorily marked by \emph{t}.  (Ex. \ref{ex-thomason-18} means `One-Night told
...
The Qeyqey\v{s}i story from which ex.  \ref{ex-thomason-18} is taken illustrates this
...
the transitive apparatus in monotransitive forms (e.g.  exx. \ref{ex-thomason-24}--\ref{ex-thomason-28}).
...
\textsc{tr.cont} suffix (ex. \ref{ex-thomason-29}).  Otherwise the ditransitive forms
...
(see e.g. Sections~2.8-9 below, especially ex. \ref{ex-thomason-44}, in which the derived
...
restriction in S\'eli\v{s}-Ql'isp\'e, as ex. \ref{ex-thomason-33} illustrates.
...
intransitives (see our ex. \ref{ex-thomason-25} above for a typical co-occurrence of the
...
discussion, compare exx. \ref{ex-thomason-35}--\ref{ex-thomason-37}:
...
Ex. \ref{ex-thomason-35} is a plain intransitive monovalent verb. In 36 a derived
...
syntactic arguments, an agent and a patient.  Ex. \ref{ex-thomason-37} contrasts with \ref{ex-thomason-36}
...
stem (e.g. ex. \ref{ex-thomason-33}), or before a lexical suffix, in which case the
potentially transitive stem formed by this suffix loses its syntactic
patient (e.g. ex. \ref{ex-thomason-39} below).
...
concerns the effect of certain lexical suffixes, as in exx. \ref{ex-thomason-38}--\ref{ex-thomason-40}.
...
suffix, as in ex. \ref{ex-thomason-33} above.  As we have seen, this is not possible
with an antipassive.
...
Qeyqey\v{s}i tale from which ex. \ref{ex-thomason-18} is taken: as described above,
