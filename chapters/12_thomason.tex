...
\itdopt{Fix all quotations. Single quotes = glossing, double quotes = quotes/distancing. Use latex
  cite for citations. Use reference mechanism for sections.}
...
object markers; these will be discussed in Section \REF{thomason_section_2.6}.  Third-person
...
discussed in Section \REF{thomason_section_2.6} and illustrated in examples \REF{ex-thomason-41}--\REF{ex-thomason-44} below.)
...
and in any case its agent is the main focus.  As we will argue in Section \REF{thomason_section_3}, this transitivity-reducing function unites the antipassive suffix
...
return to this topic in Section \REF{thomason_section_3}.
...
full-word subject and object NPs.  As we have seen in Sections~\REF{thomason_section_2.1}--\REF{thomason_section_2.5} (and
will see below in Sections~\REF{thomason_section_2.7}--\REF{thomason_section_2.9}), this case marking is consistent
...
discuss this further in Section \REF{thomason_section_3}.
...
(see e.g. Sections \ref{thomason_section_2.8}--\ref{thomason_section_2.9} below, especially example \REF{ex-thomason-44}, in which the derived
...
Vogt appears to analyze the suffix as a transitivizer (1940:59-60)\todosatz{fix reference},
...
suffix (1981:105)\todosatz{fix reference}.  Gerdts' 1993\todosatz{fix reference} analysis of the analogous
...
causative stem, as we saw in Section \REF{thomason_section_2.4}.  As a reminder of that
...
Example \REF{ex-thomason-35} is a plain intransitive monovalent verb. In 36 a derived
...
Section \REF{thomason_section_2.4}, a form \emph{\v{c}n xw\'uym} `I make someone go' is also
...
Sections~\ref{thomason_section_2.1}--\ref{thomason_section_2.9}\itdopt{In Section~2? There is
  nothing appart from the subsections 1 to 9.} fit
...
with an indefinite object (1940:31)\todosatz{fix reference}
\itdopt{use \backslash citeyearpar here}
